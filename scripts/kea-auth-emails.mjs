...
function wrapEmail({ title, greeting, paragraphs, buttonLabel, buttonHref, afterButton, code }) {
  ...
  const button = buttonLabel
    ? `<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:28px auto 8px;">
              <tr>
                <td align="center" bgcolor="#5b6cff" style="border-radius:999px;background-color:#5b6cff;">
                  <a href="${buttonHref}" target="_blank" rel="noopener noreferrer" style="display:inline-block;padding:16px 36px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:17px;font-weight:600;line-height:1.3;color:#ffffff !important;text-decoration:none;border-radius:999px;min-width:180px;text-align:center;">${buttonLabel}</a>
                </td>
              </tr>
            </table>
            <p style="margin:12px 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:13px;line-height:1.55;color:#6b778c;text-align:center;">If the button does nothing, copy this link into Safari or Chrome:</p>
            <p style="margin:8px 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:12px;line-height:1.5;word-break:break-all;text-align:center;"><a href="${buttonHref}" style="color:#2a5bd7;text-decoration:underline;">${buttonHref}</a></p>`
    : ''
